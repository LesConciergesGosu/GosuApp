...
#define APP_COLOR_NAV_TINIT [UIColor colorWithRed:88/255.f green:86/255.f blue:82/255.f alpha:1]
...
typedef NS_ENUM(NSInteger, TaskStatus) {
    TaskStatusCreated = -1,
    TAskStatusConfirmd = 0,  // the customer has requested the task
...
typedef NS_ENUM(NSInteger, ExperienceStatus) {
    ExperienceStatusCreated = -1,  // the customer has requested the experience
    ExperienceStatusConfirmed,  // User has been confirmed the experience,
                                // te experience is ready to be assigned.
    ExperiencestatusReserved,
    ExperienceStatusFinished = 2,   // All the tasks are finished.
    ExperienceStatusReviewed = 3,   // All the tasks are reviewed.
...
FOUNDATION_EXPORT NSString *const TASK_TYPE_ACCOMODATION;
FOUNDATION_EXPORT NSString *const TASK_TYPE_TRAVEL;
FOUNDATION_EXPORT NSString *const TASK_TYPE_FOOD;
FOUNDATION_EXPORT NSString *const TASK_TYPE_GIFT;
FOUNDATION_EXPORT NSString *const TASK_TYPE_ENTERTAINMENT;

FOUNDATION_EXPORT NSString *const TASK_TYPE_FLIGHT;
FOUNDATION_EXPORT NSString *const TASK_TYPE_RENTAL;
FOUNDATION_EXPORT NSString *const TASK_TYPE_LIMO;
FOUNDATION_EXPORT NSString *const TASK_TYPE_TAXI;

FOUNDATION_EXPORT NSString *const TASK_TYPE_LIMO_DESTINATION;
FOUNDATION_EXPORT NSString *const TASK_TYPE_LIMO_HOURLY;

FOUNDATION_EXPORT NSString *const TASK_TYPE_SPORTS;
FOUNDATION_EXPORT NSString *const TASK_TYPE_THEATRE;
FOUNDATION_EXPORT NSString *const TASK_TYPE_CONCERTS;
FOUNDATION_EXPORT NSString *const TASK_TYPE_NIGHTLIFE;
FOUNDATION_EXPORT NSString *const TASK_TYPE_MOVIE;

FOUNDATION_EXPORT NSString *const TASK_TYPE_FOOD_TAPAS;
FOUNDATION_EXPORT NSString *const TASK_TYPE_FOOD_FUSION;
FOUNDATION_EXPORT NSString *const TASK_TYPE_FOOD_HOMESTYLE;
FOUNDATION_EXPORT NSString *const TASK_TYPE_FOOD_ETHNIC;
...
FOUNDATION_EXPORT NSString *const CloudDeleteTask;
...
FOUNDATION_EXPORT NSString *const NotificationExperienceUpdated;
...
typedef void (^GLoginBlock)(BOOL success, id pfUser, NSString *errorDesc);
typedef void (^GCreateObjectBlock)(BOOL success, id pfObject, NSString *errorDesc);
