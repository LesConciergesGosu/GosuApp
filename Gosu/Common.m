...
NSString *const CloudDeleteTask = @"deleteTask";
...
NSString *const NotificationExperienceUpdated = @"NotificationExperienceUpdated";
...
NSString *const TASK_TYPE_ACCOMODATION = @"accomodation";
NSString *const TASK_TYPE_TRAVEL = @"travel";
NSString *const TASK_TYPE_FOOD = @"food";
NSString *const TASK_TYPE_ENTERTAINMENT = @"entertainment";
NSString *const TASK_TYPE_GIFT = @"gift";

NSString *const TASK_TYPE_FLIGHT = @"flight";
NSString *const TASK_TYPE_RENTAL = @"rental";
NSString *const TASK_TYPE_LIMO = @"limo";
NSString *const TASK_TYPE_TAXI = @"taxi";

NSString *const TASK_TYPE_SPORTS = @"sports";
NSString *const TASK_TYPE_THEATRE = @"theatre";
NSString *const TASK_TYPE_CONCERTS = @"concerts";
NSString *const TASK_TYPE_NIGHTLIFE = @"nightlife";
NSString *const TASK_TYPE_MOVIE = @"movie";

NSString *const TASK_TYPE_FOOD_TAPAS = @"tapas";
NSString *const TASK_TYPE_FOOD_FUSION = @"fusion";
NSString *const TASK_TYPE_FOOD_HOMESTYLE = @"homestyle";
NSString *const TASK_TYPE_FOOD_ETHNIC = @"ethnic";


NSString *const TASK_TYPE_LIMO_DESTINATION = @"destination";
NSString *const TASK_TYPE_LIMO_HOURLY = @"hourly";
