...
- (void) handlePushMessage:(NSDictionary *)userInfo
    ...
    switch (type) {
        ...
        {
            UIViewController *centerVC = [self.rootViewController topViewController];
            
            if ([centerVC isKindOfClass:[MyExperiencesViewController class]]) {
...
{
    [self setDeviceTokenFromData:deviceToken];
}
