...
+ (UIView*)generateModalViewWithTitle:(NSString*)title message:(NSString*)message {
    ...
    bottomBar.image = [[UIImage imageNamed:@"dialog_bottom_bar.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 10, 10, 10) resizingMode:UIImageResizingModeStretch];
    ...
    bottomBarButtonArea.image = [UIImage imageNamed:@"dialog_bottom_bar_center.png"];
    [view addSubview:bottomBarButtonArea];
    
    UIImageView *bgView = [[UIImageView alloc] initWithFrame:view.bounds];
    bgView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
    bgView.image = [[UIImage imageNamed:@"dialog_bg.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(20, 20, 20, 20) resizingMode:UIImageResizingModeStretch];
