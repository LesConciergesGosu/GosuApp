...
+ (CGFloat)heightForData:(Notification *)data {
    ...
    CGSize size = [data.message sizeWithFont:[UIFont systemFontOfSize:14] fitToSize:CGSizeMake(250, 1000)];
...
- (void)setData:(Notification *)data
{
    ...
    if (sender) {
        ...
        [self photoView].image = [UIImage imageNamed:@"logo_black"];
    ...
    // timer icon
    CGSize sz = [dateString sizeWithFont:[self dateLabel].font fitToSize:CGSizeMake(1000, 20)];
