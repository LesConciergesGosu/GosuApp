...
- (void)setReview:(NSMutableDictionary *)review {
    ...
    [self ratingView].starImage = [UIImage imageNamed:@"star_big"];
    [self ratingView].starHighlightedImage = [UIImage imageNamed:@"star_big_highlight"];
    ...
    [self personPhotoView].image = [UIImage imageNamed:@"buddy"];
