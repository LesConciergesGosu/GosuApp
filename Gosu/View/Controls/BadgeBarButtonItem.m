...
- (void)updateBadgeValueAnimated:(BOOL)animated
{
    ...
    if (animated && self.shouldAnimateBadge && ![self.badge.text intValue] != self.badgeValue) {
    ...
    // Set the new value
    self.badge.text = self.badgeValue > 99 ? @"99+" : [NSString stringWithFormat:@"%d", (int)self.badgeValue];
